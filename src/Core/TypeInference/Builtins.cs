...
#pragma warning disable IDE1006 // Naming Styles
    ...
    public class Builtins
    {
        ...
        /// </summary>
        private readonly IDictionary<string, NativeModule> modules = new Dictionary<string, NativeModule>();
        ...
        {
            string path = table.ExtendPath(analyzer, name);
        ...
        private FunType newFunc(DataType type)
        {
            ...
            FunType fun = new FunType(DataType.Unknown, type);
        ...
        {
            if (!modules.TryGetValue(name, out NativeModule wrap))
            {
                return null;
            }
        ...
        private void buildObjectType()
        {
            ...
            {
                objectType.Table.Insert(analyzer, m, newLibUrl("stdtypes"), newFunc(), BindingKind.METHOD).IsBuiltin =
                    true;
            }

            objectType.Table.Insert(analyzer, "__doc__", newLibUrl("stdtypes"), DataType.Str, BindingKind.CLASS)
                .IsBuiltin = true;
            objectType.Table.Insert(analyzer, "__class__", newLibUrl("stdtypes"), DataType.Unknown, BindingKind.CLASS)
                .IsBuiltin = true;
        }
        ...
        private void buildTupleType()
        {
            ...
            bt.Insert(analyzer, "__getslice__", newDataModelUrl("object.__getslice__"), newFunc(), BindingKind.METHOD)
                .IsBuiltin = true;
            bt.Insert(analyzer, "__getitem__", newDataModelUrl("object.__getitem__"), newFunc(), BindingKind.METHOD)
                .IsBuiltin = true;
            bt.Insert(analyzer, "__iter__", newDataModelUrl("object.__iter__"), newFunc(), BindingKind.METHOD)
                .IsBuiltin = true;
        }
        ...
        private void buildArrayType()
        {
            ...
            {
                BaseArray.Table.Insert(analyzer, m, newLibUrl("array"), newFunc(DataType.None), BindingKind.METHOD)
                    .IsBuiltin = true;
            }
            ...
            {
                BaseArray.Table.Insert(analyzer, m, newLibUrl("array"), newFunc(DataType.Int), BindingKind.METHOD)
                    .IsBuiltin = true;
            }
            ...
            {
                BaseArray.Table.Insert(analyzer, m, newLibUrl("array"), newFunc(DataType.Str), BindingKind.METHOD)
                    .IsBuiltin = true;
            }
        }
        ...
        private void buildListType()
        {
            ...
            {
                BaseList.Table.Insert(analyzer, m, newLibUrl("stdtypes"), newFunc(DataType.None), BindingKind.METHOD)
                    .IsBuiltin = true;
            }
            ...
            {
                BaseList.Table.Insert(analyzer, m, newLibUrl("stdtypes"), newFunc(DataType.Int), BindingKind.METHOD)
                    .IsBuiltin = true;
            }
        }
        ...
        private void buildNumTypes()
        {
            ...
            bnt.Insert(analyzer, "__getnewargs__", numUrl(), newFunc(newTuple(DataType.Int)), BindingKind.METHOD)
                .IsBuiltin = true;
            ...
            bct.Insert(analyzer, "__getnewargs__", numUrl(), newFunc(newTuple(DataType.Complex)), BindingKind.METHOD)
                .IsBuiltin = true;
        ...
        private void buildModuleType()
        {
            ...
            {
                BaseModule.Table.Insert(analyzer, m, newTutUrl("modules.html"), DataType.Str, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;
            }
        ...
        private void buildFileType()
        {
            ...
            table.Insert(analyzer, "readlines", newLibUrl(url), newFunc(newList(DataType.Str)), BindingKind.METHOD)
                .IsBuiltin = true;
            table.Insert(analyzer, "xreadlines", newLibUrl(url), newFunc(DataType.Str), BindingKind.METHOD).IsBuiltin =
                true;
            ...
            table.Insert(analyzer, "newlines", newLibUrl(url), newUnion(DataType.Str, newTuple(DataType.Str)),
        ...
        private void buildFunctionType()
        {
            ...
            t.Insert(analyzer, "func_closure", new Url(DATAMODEL_URL), newTuple(), BindingKind.ATTRIBUTE).IsBuiltin =
                true;
            t.Insert(analyzer, "func_code", new Url(DATAMODEL_URL), DataType.Unknown, BindingKind.ATTRIBUTE).IsBuiltin =
                true;
            t.Insert(analyzer, "func_defaults", new Url(DATAMODEL_URL), newTuple(), BindingKind.ATTRIBUTE).IsBuiltin =
                true;
            t.Insert(analyzer, "func_globals", new Url(DATAMODEL_URL),
                analyzer.TypeFactory.CreateDict(DataType.Str, DataType.Unknown),
                BindingKind.ATTRIBUTE).IsBuiltin = true;
            t.Insert(analyzer, "func_dict", new Url(DATAMODEL_URL),
                    analyzer.TypeFactory.CreateDict(DataType.Str, DataType.Unknown), BindingKind.ATTRIBUTE).IsBuiltin =
                true;
        ...
        private void buildClassType()
        {
            ...
            t.Insert(analyzer, "__dict__", new Url(DATAMODEL_URL), new DictType(DataType.Str, DataType.Unknown),
                BindingKind.ATTRIBUTE).IsBuiltin = true;
        }
        ...
        private abstract class NativeModule
        {
            ...
            protected void createModuleType()
            {
                if (module == null)
                {
                    ...
                    table = module.Table;
                    outer.analyzer.ModuleTable.Insert(outer.analyzer, name, liburl(), module, BindingKind.MODULE)
                        .IsBuiltin = true;
                }
            }
        ...
        private class BuiltinsModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                outer.analyzer.GlobalTable
                    .Insert(outer.analyzer, "__builtins__", liburl(), module, BindingKind.ATTRIBUTE).IsBuiltin = true;
        ...
        private class CPickleModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                pickler.Table.Insert(outer.analyzer, "dump", liburl(), outer.newFunc(), BindingKind.METHOD).IsBuiltin =
                    true;
                pickler.Table.Insert(outer.analyzer, "clear_memo", liburl(), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                addClass("Pickler", liburl(), pickler);

                ClassType unpickler = outer.newClass("Unpickler", table, outer.objectType);
                unpickler.Table.Insert(outer.analyzer, "load", liburl(), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                unpickler.Table.Insert(outer.analyzer, "noload", liburl(), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
        ...
        private class CollectionsModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                callable.Table.Insert(outer.analyzer, "__call__", abcUrl(), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                addClass("Callable", abcUrl(), callable);

                ClassType iterableType = outer.newClass("Iterable", table, outer.objectType);
                iterableType.Table.Insert(outer.analyzer, "__next__", abcUrl(), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                iterableType.Table.Insert(outer.analyzer, "__iter__", abcUrl(), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                addClass("Iterable", abcUrl(), iterableType);

                ClassType Hashable = outer.newClass("Hashable", table, outer.objectType);
                Hashable.Table.Insert(outer.analyzer, "__hash__", abcUrl(), outer.newFunc(DataType.Int),
                    BindingKind.METHOD).IsBuiltin = true;
                addClass("Hashable", abcUrl(), Hashable);

                ClassType Sized = outer.newClass("Sized", table, outer.objectType);
                Sized.Table.Insert(outer.analyzer, "__len__", abcUrl(), outer.newFunc(DataType.Int), BindingKind.METHOD)
                    .IsBuiltin = true;
                addClass("Sized", abcUrl(), Sized);

                ClassType containerType = outer.newClass("Container", table, outer.objectType);
                containerType.Table.Insert(outer.analyzer, "__contains__", abcUrl(), outer.newFunc(DataType.Int),
                    BindingKind.METHOD).IsBuiltin = true;
                ...
                sequenceType.Table.Insert(outer.analyzer, "__getitem__", abcUrl(), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                sequenceType.Table.Insert(outer.analyzer, "reversed", abcUrl(), outer.newFunc(sequenceType),
                    BindingKind.METHOD).IsBuiltin = true;
                sequenceType.Table.Insert(outer.analyzer, "index", abcUrl(), outer.newFunc(DataType.Int),
                    BindingKind.METHOD).IsBuiltin = true;
                sequenceType.Table.Insert(outer.analyzer, "count", abcUrl(), outer.newFunc(DataType.Int),
                    BindingKind.METHOD).IsBuiltin = true;
                ...
                mutableSequence.Table
                        .Insert(outer.analyzer, "__setitem__", abcUrl(), outer.newFunc(), BindingKind.METHOD)
                        .IsBuiltin =
                    true;
                mutableSequence.Table
                        .Insert(outer.analyzer, "__delitem__", abcUrl(), outer.newFunc(), BindingKind.METHOD)
                        .IsBuiltin =
                    true;
                ...
                setType.Table.Insert(outer.analyzer, "__getitem__", abcUrl(), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                addClass("Set", abcUrl(), setType);

                ClassType mutableSet = outer.newClass("MutableSet", table, setType);
                mutableSet.Table.Insert(outer.analyzer, "add", abcUrl(), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                mutableSet.Table.Insert(outer.analyzer, "discard", abcUrl(), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                addClass("MutableSet", abcUrl(), mutableSet);

                ClassType mapping = outer.newClass("Mapping", table, Sized, iterableType, containerType);
                mapping.Table.Insert(outer.analyzer, "__getitem__", abcUrl(), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                addClass("Mapping", abcUrl(), mapping);

                ClassType mutableMapping = outer.newClass("MutableMapping", table, mapping);
                mutableMapping.Table
                        .Insert(outer.analyzer, "__setitem__", abcUrl(), outer.newFunc(), BindingKind.METHOD)
                        .IsBuiltin =
                    true;
                mutableMapping.Table
                ...
                {
                    "append", "appendLeft", "clear",
                    "extend", "extendLeft", "rotate"
                })
                {
                    deque.Table.Insert(outer.analyzer, n, dequeUrl(), outer.newFunc(DataType.None), BindingKind.METHOD)
                        .IsBuiltin = true;
                }
                ...
                {
                    deque.Table.Insert(outer.analyzer, u, dequeUrl(), outer.newFunc(), BindingKind.METHOD).IsBuiltin =
                        true;
                }
        ...
        private class DatetimeModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                tdtable.Insert(outer.analyzer, "min", dtUrl("timedelta"), timedelta, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;
                tdtable.Insert(outer.analyzer, "max", dtUrl("timedelta"), timedelta, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;
                tdtable.Insert(outer.analyzer, "resolution", dtUrl("timedelta"), timedelta, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;

                tdtable.Insert(outer.analyzer, "days", dtUrl("timedelta"), DataType.Int, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;
                tdtable.Insert(outer.analyzer, "seconds", dtUrl("timedelta"), DataType.Int, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;
                tdtable.Insert(outer.analyzer, "microseconds", dtUrl("timedelta"), DataType.Int, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;
                ...
                tztable.Insert(outer.analyzer, "utcoffset", dtUrl("tzinfo"), outer.newFunc(timedelta),
                    BindingKind.METHOD).IsBuiltin = true;
                tztable.Insert(outer.analyzer, "dst", dtUrl("tzinfo"), outer.newFunc(timedelta), BindingKind.METHOD)
                    .IsBuiltin = true;
                tztable.Insert(outer.analyzer, "tzname", dtUrl("tzinfo"), outer.newFunc(DataType.Str),
                    BindingKind.METHOD).IsBuiltin = true;
                tztable.Insert(outer.analyzer, "fromutc", dtUrl("tzinfo"), outer.newFunc(tzinfo), BindingKind.METHOD)
                    .IsBuiltin = true;
                ...
                dtable.Insert(outer.analyzer, "resolution", dtUrl("date"), timedelta, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;

                dtable.Insert(outer.analyzer, "today", dtUrl("date"), outer.newFunc(date), BindingKind.METHOD)
                    .IsBuiltin = true;
                dtable.Insert(outer.analyzer, "fromtimestamp", dtUrl("date"), outer.newFunc(date), BindingKind.METHOD)
                    .IsBuiltin = true;
                dtable.Insert(outer.analyzer, "fromordinal", dtUrl("date"), outer.newFunc(date), BindingKind.METHOD)
                    .IsBuiltin = true;

                dtable.Insert(outer.analyzer, "year", dtUrl("date"), DataType.Int, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;
                dtable.Insert(outer.analyzer, "month", dtUrl("date"), DataType.Int, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;
                dtable.Insert(outer.analyzer, "day", dtUrl("date"), DataType.Int, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;

                dtable.Insert(outer.analyzer, "replace", dtUrl("date"), outer.newFunc(date), BindingKind.METHOD)
                    .IsBuiltin = true;
                dtable.Insert(outer.analyzer, "timetuple", dtUrl("date"), outer.newFunc(outer.Time_struct_time),
                    BindingKind.METHOD).IsBuiltin = true;

                foreach (string n in new[] { "toordinal", "weekday", "isoweekday" })
                {
                    dtable.Insert(outer.analyzer, n, dtUrl("date"), outer.newFunc(DataType.Int), BindingKind.METHOD)
                        .IsBuiltin = true;
                }

                foreach (string r in new[] { "ctime", "strftime", "isoformat" })
                {
                    dtable.Insert(outer.analyzer, r, dtUrl("date"), outer.newFunc(DataType.Str), BindingKind.METHOD)
                        .IsBuiltin = true;
                }
                ...
                ttable.Insert(outer.analyzer, "resolution", dtUrl("time"), timedelta, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;

                ttable.Insert(outer.analyzer, "hour", dtUrl("time"), DataType.Int, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;
                ttable.Insert(outer.analyzer, "minute", dtUrl("time"), DataType.Int, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;
                ttable.Insert(outer.analyzer, "second", dtUrl("time"), DataType.Int, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;
                ttable.Insert(outer.analyzer, "microsecond", dtUrl("time"), DataType.Int, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;
                ttable.Insert(outer.analyzer, "tzinfo", dtUrl("time"), tzinfo, BindingKind.ATTRIBUTE).IsBuiltin = true;

                ttable.Insert(outer.analyzer, "replace", dtUrl("time"), outer.newFunc(time), BindingKind.METHOD)
                    .IsBuiltin = true;

                foreach (string l in new[] { "isoformat", "strftime", "tzname" })
                {
                    ttable.Insert(outer.analyzer, l, dtUrl("time"), outer.newFunc(DataType.Str), BindingKind.METHOD)
                        .IsBuiltin = true;
                }

                foreach (string f in new[] { "utcoffset", "dst" })
                {
                    ttable.Insert(outer.analyzer, f, dtUrl("time"), outer.newFunc(timedelta), BindingKind.METHOD)
                        .IsBuiltin = true;
                }
                ...
                {
                    "combine", "fromordinal", "fromtimestamp", "now",
                    "strptime", "today", "utcfromtimestamp", "utcnow"
                })
                {
                    dttable.Insert(outer.analyzer, c, dtUrl("datetime"), outer.newFunc(datetime), BindingKind.METHOD)
                        .IsBuiltin = true;
                }

                dttable.Insert(outer.analyzer, "min", dtUrl("datetime"), datetime, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;
                dttable.Insert(outer.analyzer, "max", dtUrl("datetime"), datetime, BindingKind.ATTRIBUTE).IsBuiltin =
                    true;
                dttable.Insert(outer.analyzer, "resolution", dtUrl("datetime"), timedelta, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;

                dttable.Insert(outer.analyzer, "date", dtUrl("datetime"), outer.newFunc(date), BindingKind.METHOD)
                    .IsBuiltin = true;

                foreach (string x in new[] { "time", "timetz" })
                {
                    dttable.Insert(outer.analyzer, x, dtUrl("datetime"), outer.newFunc(time), BindingKind.METHOD)
                        .IsBuiltin = true;
                }

                foreach (string y in new[] { "replace", "astimezone" })
                {
                    dttable.Insert(outer.analyzer, y, dtUrl("datetime"), outer.newFunc(datetime), BindingKind.METHOD)
                        .IsBuiltin = true;
                }

                dttable.Insert(outer.analyzer, "utctimetuple", dtUrl("datetime"), outer.newFunc(outer.Time_struct_time),
                    BindingKind.METHOD).IsBuiltin = true;
            }
        }
        ...
        private class DbmModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                string path = table.ExtendPath(outer.analyzer, "dbm");
        ...
        private class GdbmModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                string path = table.ExtendPath(outer.analyzer, name);
                ClassType gdbm = new ClassType("gdbm", table, path, outer.BaseDict);
                gdbm.Table.Insert(outer.analyzer, "firstkey", liburl(), outer.newFunc(DataType.Str), BindingKind.METHOD)
                    .IsBuiltin = true;
                gdbm.Table.Insert(outer.analyzer, "nextkey", liburl(), outer.newFunc(DataType.Str), BindingKind.METHOD)
                    .IsBuiltin = true;
                gdbm.Table.Insert(outer.analyzer, "reorganize", liburl(), outer.newFunc(DataType.None),
                    BindingKind.METHOD).IsBuiltin = true;
                gdbm.Table.Insert(outer.analyzer, "sync", liburl(), outer.newFunc(DataType.None), BindingKind.METHOD)
                    .IsBuiltin = true;
        ...
        private class GrpModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                struct_group.Table.Insert(outer.analyzer, "gr_name", liburl(), DataType.Str, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;
                struct_group.Table.Insert(outer.analyzer, "gr_passwd", liburl(), DataType.Str, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;
                struct_group.Table.Insert(outer.analyzer, "gr_gid", liburl(), DataType.Int, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;
                struct_group.Table.Insert(outer.analyzer, "gr_mem", liburl(), outer.newList(DataType.Str),
                    BindingKind.ATTRIBUTE).IsBuiltin = true;
        ...
        private class ImpModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                addFunction("get_suffixes", liburl(),
                    outer.newList(outer.newTuple(DataType.Str, DataType.Str, DataType.Int)));
                ...
                impNullImporter.Table.Insert(outer.analyzer, "find_module", liburl(), outer.newFunc(DataType.None),
                    BindingKind.FUNCTION).IsBuiltin = true;
        ...
        private class ItertoolsModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                iterator.Table.Insert(outer.analyzer, "next", liburl(), outer.newFunc(), BindingKind.METHOD).IsBuiltin =
                    true;

                foreach (string s in new[]
                {
                    "chain", "combinations", "count", "cycle",
        ...
        private class Md5Module : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                md5.Table.Insert(outer.analyzer, "update", liburl(), outer.newFunc(), BindingKind.METHOD).IsBuiltin =
                    true;
                md5.Table.Insert(outer.analyzer, "digest", liburl(), outer.newFunc(DataType.Str), BindingKind.METHOD)
                    .IsBuiltin = true;
                md5.Table.Insert(outer.analyzer, "hexdigest", liburl(), outer.newFunc(DataType.Str), BindingKind.METHOD)
                    .IsBuiltin = true;
                md5.Table.Insert(outer.analyzer, "copy", liburl(), outer.newFunc(md5), BindingKind.METHOD).IsBuiltin =
                    true;
        ...
        private class MmapModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                {
                    mmap.Table.Insert(outer.analyzer, s, liburl(), DataType.Int, BindingKind.ATTRIBUTE).IsBuiltin =
                        true;
                }

                foreach (string fstr in new[] { "read", "read_byte", "readline" })
                {
                    mmap.Table.Insert(outer.analyzer, fstr, liburl(), outer.newFunc(DataType.Str), BindingKind.METHOD)
                        .IsBuiltin = true;
                }

                foreach (string fnum in new[] { "find", "rfind", "tell" })
                {
                    mmap.Table.Insert(outer.analyzer, fnum, liburl(), outer.newFunc(DataType.Int), BindingKind.METHOD)
                        .IsBuiltin = true;
                }

                foreach (string fnone in new[]
                {
                    "close", "flush", "move", "resize", "seek",
                    "write", "write_byte"
                })
                {
                    mmap.Table.Insert(outer.analyzer, fnone, liburl(), outer.newFunc(DataType.None), BindingKind.METHOD)
                        .IsBuiltin = true;
                }
        ...
        private class OsModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                foreach (string s in new[]
                {
                    "_Environ", "_copy_reg", "_execvpe", "_exists",
            ...
            private void initProcBindings()
            {
                ...
                foreach (string s in new[]
                {
                    "chdir", "fchdir", "putenv", "setegid", "seteuid",
                ...
                foreach (string s in new[]
                {
                    "getegid", "getgid", "getpgid", "getpgrp",
            ...
            private void initProcMgmtBindings()
            {
                ...
                foreach (string s in new[]
                {
                    "nice", "spawnl", "spawnle", "spawnlp", "spawnlpe",
                ...
                addFunction("times", liburl(a),
                    outer.newTuple(DataType.Int, DataType.Int, DataType.Int, DataType.Int, DataType.Int));
            ...
            private void initFileBindings()
            {
                ...
                addFunction("popen3", liburl(a),
                    outer.newTuple(outer.BaseFileInst, outer.BaseFileInst, outer.BaseFileInst));
                ...
                foreach (string s in new[]
                {
                    "O_APPEND", "O_CREAT", "O_DIRECT", "O_DIRECTORY",
            ...
            private void initFileAndDirBindings()
            {
                ...
                foreach (string s in new[]
                {
                    "chflags", "chroot", "chmod", "chown", "lchflags",
            ...
            private void initMiscSystemInfo()
            {
                ...
                foreach (string s in new[]
                {
                    "curdir", "pardir", "sep", "altsep", "extsep",
            ...
            private void initOsPathModule()
            {
                ...
                {
                    ospath.Insert(outer.analyzer, s, newLibUrl("os.path", s), outer.newFunc(DataType.Str),
                        BindingKind.FUNCTION).IsBuiltin = true;
                }
                ...
                {
                    ospath.Insert(outer.analyzer, s, newLibUrl("os.path", s), outer.newFunc(DataType.Int),
                        BindingKind.FUNCTION).IsBuiltin = true;
                }
                ...
                ospath.Insert(outer.analyzer, "walk", newLibUrl("os.path"), outer.newFunc(DataType.None),
                    BindingKind.FUNCTION).IsBuiltin = true;
                ...
                {
                    ospath.Insert(outer.analyzer, s, newLibUrl("os.path", s), DataType.Str, BindingKind.ATTRIBUTE)
                        .IsBuiltin = true;
                }

                ospath.Insert(outer.analyzer, "os", liburl(), module, BindingKind.ATTRIBUTE).IsBuiltin = true;
                ...
                ospath.Insert(outer.analyzer, "_varprog", newLibUrl("os.path"), DataType.Unknown, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;
            }
        }
        ...
        private class PwdModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                foreach (string s in new[]
                {
                    "pw_nam", "pw_passwd", "pw_uid", "pw_gid",
                    "pw_gecos", "pw_dir", "pw_shell"
                })
                {
                    struct_pwd.Table.Insert(outer.analyzer, s, liburl(), DataType.Int, BindingKind.ATTRIBUTE)
                        .IsBuiltin = true;
                }
        ...
        private class ResourceModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                {
                    ru.Table.Insert(outer.analyzer, ruf, liburl("resource-usage"), DataType.Int, BindingKind.ATTRIBUTE)
                        .IsBuiltin = true;
                }
        ...
        private class SelectModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                epoll.Table.Insert(outer.analyzer, "close", newLibUrl("select", a), outer.newFunc(DataType.None),
                    BindingKind.METHOD).IsBuiltin = true;
                epoll.Table.Insert(outer.analyzer, "fileno", newLibUrl("select", a), outer.newFunc(DataType.Int),
                    BindingKind.METHOD).IsBuiltin = true;
                epoll.Table.Insert(outer.analyzer, "fromfd", newLibUrl("select", a), outer.newFunc(epoll),
                    BindingKind.METHOD).IsBuiltin = true;
                foreach (string s in new[] { "register", "modify", "unregister", "poll" })
                {
                    epoll.Table.Insert(outer.analyzer, s, newLibUrl("select", a), outer.newFunc(), BindingKind.METHOD)
                        .IsBuiltin = true;
                }
                ...
                poll.Table.Insert(outer.analyzer, "register", newLibUrl("select", a), outer.newFunc(),
                    BindingKind.METHOD).IsBuiltin = true;
                poll.Table.Insert(outer.analyzer, "modify", newLibUrl("select", a), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                poll.Table.Insert(outer.analyzer, "unregister", newLibUrl("select", a), outer.newFunc(),
                    BindingKind.METHOD).IsBuiltin = true;
                ...
                foreach (string s in new[]
                {
                    "POLLERR", "POLLHUP", "POLLIN", "POLLMSG",
                ...
                kqueue.Table.Insert(outer.analyzer, "close", newLibUrl("select", a), outer.newFunc(DataType.None),
                    BindingKind.METHOD).IsBuiltin = true;
                kqueue.Table.Insert(outer.analyzer, "fileno", newLibUrl("select", a), outer.newFunc(DataType.Int),
                    BindingKind.METHOD).IsBuiltin = true;
                kqueue.Table.Insert(outer.analyzer, "fromfd", newLibUrl("select", a), outer.newFunc(kqueue),
                    BindingKind.METHOD).IsBuiltin = true;
                ...
                {
                    kevent.Table.Insert(outer.analyzer, s, newLibUrl("select", a), DataType.Unknown,
                        BindingKind.ATTRIBUTE).IsBuiltin = true;
                }
        ...
        private class ShaModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                sha.Table.Insert(outer.analyzer, "update", liburl(), outer.newFunc(), BindingKind.METHOD).IsBuiltin =
                    true;
                sha.Table.Insert(outer.analyzer, "digest", liburl(), outer.newFunc(DataType.Str), BindingKind.METHOD)
                    .IsBuiltin = true;
                sha.Table.Insert(outer.analyzer, "hexdigest", liburl(), outer.newFunc(DataType.Str), BindingKind.METHOD)
                    .IsBuiltin = true;
                sha.Table.Insert(outer.analyzer, "copy", liburl(), outer.newFunc(sha), BindingKind.METHOD).IsBuiltin =
                    true;
        ...
        private class SpwdModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                foreach (string s in new[]
                {
                    "sp_nam", "sp_pwd", "sp_lstchg", "sp_min",
                    "sp_max", "sp_warn", "sp_inact", "sp_expire",
                    "sp_flag"
                })
                {
                    struct_spwd.Table.Insert(outer.analyzer, s, liburl(), DataType.Int, BindingKind.ATTRIBUTE)
                        .IsBuiltin = true;
                }
        ...
        private class StructModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                t.Insert(outer.analyzer, "pack", liburl("struct-objects"), outer.newFunc(DataType.Str),
                    BindingKind.METHOD).IsBuiltin = true;
                t.Insert(outer.analyzer, "pack_into", liburl("struct-objects"), outer.newFunc(), BindingKind.METHOD)
                    .IsBuiltin = true;
                t.Insert(outer.analyzer, "unpack", liburl("struct-objects"), outer.newFunc(outer.newTuple()),
                    BindingKind.METHOD).IsBuiltin = true;
                t.Insert(outer.analyzer, "unpack_from", liburl("struct-objects"), outer.newFunc(outer.newTuple()),
                    BindingKind.METHOD).IsBuiltin = true;
                t.Insert(outer.analyzer, "format", liburl("struct-objects"), DataType.Str, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;
                t.Insert(outer.analyzer, "size", liburl("struct-objects"), DataType.Int, BindingKind.ATTRIBUTE)
                    .IsBuiltin = true;
            }
        }
        ...
        private class SysModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                foreach (string s in new[]
                {
                    "argv", "builtin_module_names", "path",
        ...
        private class ThreadModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                @lock.Table.Insert(outer.analyzer, "acquire", liburl(), DataType.Int, BindingKind.METHOD).IsBuiltin =
                    true;
                @lock.Table.Insert(outer.analyzer, "locked", liburl(), DataType.Int, BindingKind.METHOD).IsBuiltin =
                    true;
                @lock.Table.Insert(outer.analyzer, "release", liburl(), DataType.None, BindingKind.METHOD).IsBuiltin =
                    true;
        ...
        private class TimeModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                InstanceType struct_time = outer.Time_struct_time =
                    new InstanceType(outer.newClass("datetime", table, outer.objectType));
                ...
                {
                    struct_time.Table.Insert(outer.analyzer, s, liburl("struct_time"), DataType.Int,
                        BindingKind.ATTRIBUTE).IsBuiltin = true;
                }
        ...
        private class ZipimportModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                t.Insert(outer.analyzer, "get_code", liburl(), DataType.Unknown, BindingKind.METHOD).IsBuiltin =
                    true; // XXX:  code object
                ...
                t.Insert(outer.analyzer, "load_module", liburl(), outer.newModule("<?>"), BindingKind.METHOD)
                    .IsBuiltin = true;
        ...
        private class ZlibModule : NativeModule
        {
            ...
            public override void initBindings()
            {
                ...
                {
                    compress.Table.Insert(outer.analyzer, s, newLibUrl("zlib"), DataType.Str, BindingKind.METHOD)
                        .IsBuiltin = true;
                }

                compress.Table.Insert(outer.analyzer, "copy", newLibUrl("zlib"), compress, BindingKind.METHOD)
                    .IsBuiltin = true;
                ...
                {
                    decompress.Table.Insert(outer.analyzer, s, newLibUrl("zlib"), DataType.Str, BindingKind.ATTRIBUTE)
                        .IsBuiltin = true;
                }

                foreach (string s in new[] { "decompress", "flush" })
                {
                    decompress.Table.Insert(outer.analyzer, s, newLibUrl("zlib"), DataType.Str, BindingKind.METHOD)
                        .IsBuiltin = true;
                }

                decompress.Table.Insert(outer.analyzer, "copy", newLibUrl("zlib"), decompress, BindingKind.METHOD)
                    .IsBuiltin = true;
