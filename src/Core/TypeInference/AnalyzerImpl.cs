...
namespace Pytocs.Core.TypeInference
{
    ...
    public class AnalyzerImpl : Analyzer
    {
        ...
        public AnalyzerImpl(IFileSystem fs, ILogger logger, Dictionary<string, object> options, DateTime startTime)
        {
            ...
            Resolved = new HashSet<Identifier>();
            Unresolved = new HashSet<Identifier>();
        ...
        public HashSet<Identifier> Resolved { get; }
        public HashSet<Identifier> Unresolved { get; }
        ...
        public string MakeQname(List<Identifier> names)
        {
            if (names.Count == 0)
            {
                return "";
        ...
        public DataType LoadModule(List<Identifier> name, State state)
        {
            if (name.Count == 0)
            {
                return null;
